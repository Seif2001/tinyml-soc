...
00000000 <start>:
  ...
  84:	18450513          	addi	a0,a0,388 # 204 <_sidata>
...
00000190 <main>:
 ...
 194:	0107a683          	lw	a3,16(a5) # 20000010 <gpio_oe>
 198:	200007b7          	lui	a5,0x20000
 19c:	0087a703          	lw	a4,8(a5) # 20000008 <uart_bauddiv>
 1a0:	ff010113          	addi	sp,sp,-16
 1a4:	200007b7          	lui	a5,0x20000
 1a8:	00112623          	sw	ra,12(sp)
 1ac:	00c7a783          	lw	a5,12(a5) # 2000000c <uart_ctrl>
 1b0:	fff00613          	li	a2,-1
 1b4:	00c6a023          	sw	a2,0(a3)
 1b8:	00a00693          	li	a3,10
 1bc:	00d72023          	sw	a3,0(a4)
 1c0:	00100713          	li	a4,1
 1c4:	00e7a023          	sw	a4,0(a5)
 1c8:	1f400513          	li	a0,500
 1cc:	f61ff0ef          	jal	12c <uart_puts>
 1d0:	200007b7          	lui	a5,0x20000
 1d4:	0147a703          	lw	a4,20(a5) # 20000014 <gpio_data>
 1d8:	00c12083          	lw	ra,12(sp)
 1dc:	f00fe7b7          	lui	a5,0xf00fe
 1e0:	00e78793          	addi	a5,a5,14 # f00fe00e <_stack+0xd00fc00e>
 1e4:	00f72023          	sw	a5,0(a4)
 1e8:	00000513          	li	a0,0
 1ec:	01010113          	addi	sp,sp,16
 1f0:	00008067          	ret
 1f4:	6548                	.insn	2, 0x6548
 1f6:	6c6c                	.insn	2, 0x6c6c
 1f8:	6f57206f          	j	730ec <_sidata+0x72ee8>
 1fc:	6c72                	.insn	2, 0x6c72
 1fe:	2164                	.insn	2, 0x2164
